...
<body>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="/cetakMhs" target="_blank">
                                    <div class="btn btn-sm btn-info mb-3"> Cetak Data Semua Mahasiswa</div>
                                </a>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered ">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalToggleLabel2">Tambah Data Mahasiswa </h5>
                                                ...
                                                <div class="container">
                                                    <form action="/tambahMahasiswa" method="post">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" class="form-control" name="username_mahasiswa" required>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-md-3 col-form-label">Password</label>
                                                            <div class="col-md-9">
                                                                <input type="password" class="form-control" name="password_mahasiswa" required>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" class="form-control" name="judul_ta" required>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-md-3 col-form-label">Kaprodi</label>
                                                            <div class="col-md-9">
                                                        ...
                                                        <input id="tanggal_input" type="hidden" name="tanggal_input" value="">
                                ...
                                <script>
                                    ...
                                    document.getElementById('tanggal_input').value = tanggal + "-" + arrbulan[bulan] + "-" + tahun + " Pukul " + jam + " : " + menit;
                                    // document.getElementById('tanggal_input').value = "ansel";
                                </script>
                                            ...
                                            foreach ($mahasiswa as $m) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <span class="btn btn-sm bg-warning text-white" data-bs-target="#editModal<?= $m['id'] ?>" data-bs-toggle="modal" data-bs-dismiss="modal">Edit</span>
                                                        <a href="/deleteMahasiswaProposal/<?= $m['id'] ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')"> <span class="btn btn-sm bg-danger text-white">Hapus</span></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
    ...
    <script>
        function htmlTableToExcel(type) {
            ...
            XLSX.writeFile(excelFile, 'Daftar Mahasiswa Tugas Akhir - Teknik Informatika.' + type);
        }
    </script>
</body>
