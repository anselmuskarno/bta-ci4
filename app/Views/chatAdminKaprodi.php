                                        ...
                                        <div class="chat-box">
                                            <div class="chats">
                                                ...
                                                <?php foreach ($dosen as $d) : ?>
                                                    ...
                                                    <?php if ($d['file_chat_admin'] != null &&  $d['status_hapus_chat_admin'] == null) { ?>
                                                                ...
                                                                <div class="chat-bubble d-flex justify-content-end">
                                                                    ...
                                                                    <div class="chat-content">
                                                                        ...
                                                                        <?php } else if ($d['extensiFile_chat_admin'] != "png" || $d['extensiFile_chat_admin'] != "jpg") { ?>
                                                                            <a target="_blank" href="<?= base_url() . 'uploadedFile/' . $d['file_chat_admin'] ?>"><?= $d['file_chat_admin']  ?></a> <br>
                                                                        <?php } ?>
                                                    ...
                                                    <?php } else if ($d['isi_chat_admin'] != null &&  $d['status_hapus_chat_admin'] == null) { ?>
                                                        <div class="chat chat-right" data-bs-toggle="modal" data-bs-target="#exampleModal<?= $d['id'] ?>">
                                                            <div class="chat-body ansel">
                                                                <div class="chat-bubble">
                                                                    <div class="chat-content">
                                                                        <p class="paragraph"><?= $d['isi_chat_admin']  ?></p>
                                                                        <span class="chat-time spanku">8:30 am</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    <?php } else if ($d['status_hapus_chat_admin'] != null) { ?>
                                                    ...
                                                    <?php } else if ($d['isi_chat_kaprodi'] != null) { ?>
                                                        <div class="chat chat-left">
                                                            ...
                                                            <div class="chat-body">
                                                                <div class="chat-bubble">
                                                                    <div class="chat-content">
                                                                        <p><?= $d['isi_chat_kaprodi']  ?></p>
                                                                        <span class="chat-time">8:30 am</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    <?php } else if ($d['file_chat_kaprodi'] != null) { ?>
                                                        <div class="chat chat-left">
                                                            <div class="chat-avatar">
                                                                <a href="#!" class="avatar">
                                                                    <img alt="<?= session()->get('nama_mahasiswa'); ?>" src="admin/assets/img/user.jpg" class="img-fluid rounded-circle">
                                                                ...
                                                                <div class="chat-bubble">
                                                                    <div class="chat-content">
                                                                        ...
                                                                        <?php } else if ($d['extensiFile_chat_kaprodi'] != "png" || $d['extensiFile_chat_kaprodi'] != "jpg") { ?>
                                                                            <a target="_blank" href="<?= base_url() . 'uploadedFile/' . $d['file_chat_kaprodi'] ?>"><?= $d['file_chat_kaprodi']  ?></a><br> <br>
                                                                        <?php } ?>
                                                                        <span class="chat-time spanku">8:30 am</span>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="modal-dialog modal-dialog-centered " style="width: 300px;">
                                                                    <div class="modal-content">
                                                                        <div class="modal-footer text-center">
                                                                            ...
                                                                            <form action="/deleteChatAdmin/<?= $d['id'] ?>" method="post">
                                                                                ...
                                                                                <input type="hidden" name="status_hapus_chat_admin" value="Anda menghapus pesan ini">
                                                        ...
                                                        <center>
                                                            <div style="padding-top:150px">
                                                                <div class="modal-dialog modal-dialog-centered " style="width: 300px;">
                                                                    <div class="modal-content">
                                                                        <div class="modal-footer text-center">
                                                                            <form action="deletePermanenChatAdmin/<?= $d['id'] ?>" method="post">
                                ...
                                <div class="message-bar">
                                    <div class="message-inner">
                                        ...
                                        <div class="message-area">
                                            <form action="/tambahChatDariAdmin" method="post">
                                                <?= csrf_field(); ?>
                                                <div class="input-group">
                                                    <input type="text" class="form-control" placeholder="Ketik pesan" name="isi_chat_admin" autofocus required>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body p-t-0">
                            <form id="js-upload-form" action="/lampirkanFileAdmin/save" method="post" enctype="multipart/form-data">
                                <input type="file" class="upload-drop-zone form-control" id="drop-zone" name="file_chat_admin">
