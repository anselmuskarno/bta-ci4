...
<body>
            ...
            <div class="header">
                ...
                <ul class="nav user-menu float-right">
                    ...
                    <li class="nav-item dropdown has-arrow">
                        ...
                        <div class="dropdown-menu"> <a class="dropdown-item" href="/">Logout</a>
                        </div>
                    </li>
                </ul>
                <div class="dropdown mobile-user-menu float-right">
                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fas fa-ellipsis-v"></i></a>
                    <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="/">Logout</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    ...
                    <ul class="sidebar-ul">
                        ...
                        <li class=" ">
                            <a href="adminTutup"><img src="admin/assets/img/sidebar/icon-2.png" alt="icon"> <span> Ujian Skripsi</span>
                            </a>
                        </li>
                        <li class=" ">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="/cetakMhsACCHasil" target="_blank">
                                    <div class="btn btn-sm btn-warning mb-3">Cetak Data Mahasiswa Sudah ACC</div>
                                </a>
                                <a href="/cetakMhsBelumACCHasil" target="_blank">
                                    <div class="btn btn-sm btn-secondary mb-3">Cetak Data Mahasiswa Belum ACC</div>
                                </a>
                                <button class="btn btn-sm btn-success mb-3" id="button" onclick="htmlTableToExcel('xlsx')">Export ke Excel</button>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($mahasiswa as $m) : ?>
                                                <tr>
                                                    ...
                                                    <td><?= $m['nim']  ?></td>
                                                    <td><?= $m['nama_dosen_1']  ?> <br><?php if ($m['acc_dosen1'] == "1") { ?>
                                                            <span class="badge bg-success text-white">Sudah ACC</span>
                                                        <?php  } else { ?>
                                                            <span class="badge bg-danger text-white">Belum ACC</span>
                                                        <?php  } ?>
                                                    </td>
                                                    <td><?= $m['nama_dosen_2']  ?> <br><?php if ($m['acc_dosen2'] == "1") { ?>
                                                            <span class="badge bg-success text-white">Sudah ACC</span>
                                                        <?php  } else { ?>
                                                            <span class="badge bg-danger text-white">Belum ACC</span>
                                                        <?php  } ?>
                                                    </td>
                                                    <td><?= $m['nama_kaprodi']  ?> <br><?php if ($m['acc_kaprodi'] == "1") { ?>
                                                            <span class="badge bg-success text-white">Sudah ACC</span>
                                                        <?php  } else { ?>
                                                            <span class="badge bg-danger text-white">Belum ACC</span>
                                                        <?php  } ?>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php if ($m['acc_dosen1'] == "1" && $m['acc_dosen2'] == "1" && $m['acc_kaprodi'] == "1") { ?>
                                                            <form action="/pindahKeTutup/<?= $m['id'] ?>" method="post" class="d-inline">
                                                                <input type="hidden" name="nama_ujian" value="tutup">
                                                                <button type="submit" class="btn btn-sm bg-warning text-white">Pindahkan Ke Ujian Tutup</button>
                                                            </form>
                                                        <?php  } else { ?>
                                                            <span class="btn btn-sm bg-secondary text-white">Menunggu Persetujuan</span>
                                                        <?php  } ?>

                                                        <a href="/deleteMahasiswaHasil/<?= $m['id'] ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')"> <span class="btn btn-sm bg-danger text-white">Hapus</span></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
    ...
    <script>
        function htmlTableToExcel(type) {
            ...
            XLSX.writeFile(excelFile, 'Daftar Seminar Hasil - Teknik Informatika.' + type);
        }
    </script>
</body>
