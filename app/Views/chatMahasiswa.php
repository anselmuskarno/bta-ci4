            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    ...
                    <ul class="sidebar-ul">
                        ...
                        <li class="active ">
                            <a href="#!"><img src="admin/assets/img/sidebar/icon-2.png" alt="icon"> <span> Chat</span>
                            </a>
                        </li>
                    ...
                    <div class="col-lg-9 message-view task-view">
                        <div class="chat-window">
                            <div class="fixed-header">
                                <div class="navbar">
                                    <div class="user-details mr-auto">
                                        ...
                                        <div class="user-info float-left">
                                            <a href="#!" title="Mike Litorus"><span class="font-bold"><?= $nama_mahasiswa ?></span> </a> <br>
                                            <?php if ($dosen_online == "dosen1") { ?>
                                                <span class="Last-seen">Mahasiswa</span> <span class="badge bg-warning text-center mx-auto text-white">Anda Sebagai Dosen Pembimbing 1</span>

                                            <?php } else { ?>
                                                <span class="Last-seen">Mahasiswa</span> <span class="badge bg-warning text-center mx-auto text-white">Anda Sebagai Dosen Pembimbing 2</span>
                                ...
                                <div class="text-center mt-2" style="font-weight: bold;">
                                    <div class="text-muted">Judul TA : </div> <?= $judul_ta ?>
                                </div>
                            </div>
                                            ...
                                            <div class="chats" id="printableArea">
                                                <?php if ($dosen_online == "dosen1") { ?>
                                                    ...
                                                    <?php foreach ($dosen as $d) : ?>
                                                        ...
                                                        <?php if ($d['file_chat_dosen1_ke_mhs'] != null &&  $d['status_hapus_chat_dari_dosen1'] == null) { ?>
                                                        ...
                                                        <?php } else if ($d['chat_dari_dosen1'] != null &&  $d['status_hapus_chat_dari_dosen1'] == null) { ?>
                                                            <div class="chat chat-right" data-bs-toggle="modal" data-bs-target="#exampleModal<?= $d['id'] ?>">
                                                                <div class="chat-body ansel">
                                                                    <div class="chat-bubble">
                                                                        <div class="chat-content">
                                                                            <p class="paragraph"><?= $d['chat_dari_dosen1']  ?></p>
                                                                            <span class="chat-time spanku">8:30 am</span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        <?php } else if ($d['status_hapus_chat_dari_dosen1'] != null && $d['chat_dari_dosen1'] == null) { ?>
                                                        ...
                                                        <?php } else if ($d['chat_ke_dosen_1'] != null) { ?>
                                                            <div class="chat chat-left">
                                                                <div class="chat-avatar">
                                                                    <a href="#!" class="avatar">
                                                                        <img alt="<?= $nama_mahasiswa; ?>" src="admin/assets/img/user.jpg" class="img-fluid rounded-circle">
                                                                    </a>
                                                                </div>
                                                                <div class="chat-body">
                                                                    <div class="chat-bubble">
                                                                        <div class="chat-content">
                                                                            <p><?= $d['chat_ke_dosen_1']  ?></p>
                                                                            <span class="chat-time">8:30 am</span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        <?php } else  if ($d['file_chat_ke_dosen1'] != null &&  $d['status_hapus_chat_dari_dosen1'] == null) { ?>
                                                            <div class="chat chat-left">
                                                                <div class="chat-avatar">
                                                                    <a href="#!" class="avatar">
                                                                        <img alt="<?= $nama_mahasiswa; ?>" src="admin/assets/img/user.jpg" class="img-fluid rounded-circle">
                                                ...
                                                <?php } else { ?>
                                                    <?php foreach ($dosen as $d) : ?>
                                                        <?php if ($d['file_chat_dosen2_ke_mhs'] != null &&  $d['status_hapus_chat_dari_dosen2'] == null) { ?>
                                                            <div class="chat chat-right">
                                                                <div class="chat-body ansel">
                                                                    <div class="chat-bubble d-flex justify-content-end">

                                                                        <div class="chat-content">
                                                                            <?php if ($d['extensiFileDosen2_ke_mhs'] == "docx" || $d['extensiFileDosen2_ke_mhs'] == "doc") { ?>
                                                                                <img src="iconFile/word.png" style="width: 20px; height:20px" alt="">
                                                                            <?php } else if ($d['extensiFileDosen2_ke_mhs'] == "xlsx" || $d['extensiFileDosen2_ke_mhs'] == "xlsm" || $d['extensiFileDosen2_ke_mhs'] == "xlsb" || $d['extensiFileDosen2_ke_mhs'] == "xlsb") { ?>
                                                                                <img src="iconFile/excel.png" style="width: 20px; height:20px" alt="">
                                                                            <?php } else if ($d['extensiFileDosen2_ke_mhs'] == "pdf") { ?>
                                                                                <img src="iconFile/pdf.png" style="width: 20px; height:20px" alt="">
                                                                            <?php } ?>
                                                                            <?php if ($d['extensiFileDosen2_ke_mhs'] == "png" || $d['extensiFileDosen2_ke_mhs'] == "jpg") { ?>
                                                                                <a target="_blank" href="<?= base_url() . 'uploadedFile/' . $d['file_chat_dosen2_ke_mhs'] ?>">
                                                                                    <img src="uploadedFile/<?= $d['file_chat_dosen2_ke_mhs'] ?>" style="width: 70px; height:70px" alt=""> <br>
                                                                                </a> <br>
                                                                            <?php } else if ($d['extensiFileDosen2_ke_mhs'] != "png" || $d['extensiFileDosen2_ke_mhs'] != "jpg") { ?>
                                                                                <a target="_blank" href="<?= base_url() . 'uploadedFile/' . $d['file_chat_dosen2_ke_mhs'] ?>"><?= $d['file_chat_dosen2_ke_mhs']  ?></a> <br>
                                                                            <?php } ?>
                                                                            <div class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal<?= $d['id'] ?>">Kelola File</div>
                                                                            <span class="chat-time spanku">8:30 am</span>
                                                                        </div>
                                                        ...
                                                        <?php } else if ($d['chat_dari_dosen2'] != null &&  $d['status_hapus_chat_dari_dosen2'] == null) { ?>
                                                            <div class="chat chat-right" data-bs-toggle="modal" data-bs-target="#exampleModal<?= $d['id'] ?>">
                                                                <div class="chat-body ansel">
                                                                    <div class="chat-bubble">
                                                                        <div class="chat-content">
                                                                            <p class="paragraph"><?= $d['chat_dari_dosen2']  ?></p>
                                                                            <span class="chat-time spanku">8:30 am</span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        <?php } else if ($d['status_hapus_chat_dari_dosen2'] != null) { ?>
                                                            <div class="chat chat-right" data-bs-toggle="modal" data-bs-target="#exampleModal2<?= $d['id'] ?>">
                                                                <div class="chat-body ansel">
                                                                    <div class="chat-bubble">
                                                                        <div class="chat-content">
                                                        ...
                                                        <?php } else if ($d['chat_ke_dosen_2'] != null) { ?>
                                                            <div class="chat chat-left">
                                                                <div class="chat-avatar">
                                                                    <a href="#!" class="avatar">
                                                                        <img alt="<?= $nama_mahasiswa; ?>" src="admin/assets/img/user.jpg" class="img-fluid rounded-circle">
                                                                ...
                                                                <div class="chat-body">
                                                                    <div class="chat-bubble">
                                                                        <div class="chat-content">
                                                                            <p><?= $d['chat_ke_dosen_2']  ?></p>
                                                                            <span class="chat-time">8:30 am</span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        <?php } else  if ($d['file_chat_ke_dosen2'] != null &&  $d['status_hapus_chat_dari_dosen2'] == null) { ?>
                                                            <div class="chat chat-left">
                                                                <div class="chat-avatar">
                                                                    <a href="#!" class="avatar">
                                                                        <img alt="<?= $nama_mahasiswa; ?>" src="admin/assets/img/user.jpg" class="img-fluid rounded-circle">
                                                                ...
                                                                <div class="chat-body">
                                                                    <div class="chat-content">
                                                                        <?php if ($d['extensiFile_ke_dosen2'] == "docx" || $d['extensiFile_ke_dosen2'] == "doc") { ?>
                                                                            <img src="iconFile/word.png" style="width: 20px; height:20px" alt="">
                                                                        <?php } else if ($d['extensiFile_ke_dosen2'] == "xlsx" || $d['extensiFile_ke_dosen2'] == "xlsm" || $d['extensiFile_ke_dosen2'] == "xlsb" || $d['extensiFile_ke_dosen2'] == "xlsb") { ?>
                                                                            <img src="iconFile/excel.png" style="width: 20px; height:20px" alt="">
                                                                        <?php } else if ($d['extensiFile_ke_dosen2'] == "pdf") { ?>
                                                                            <img src="iconFile/pdf.png" style="width: 20px; height:20px" alt="">
                                                                        <?php } ?>
                                                                        <?php if ($d['extensiFile_ke_dosen2'] == "png" || $d['extensiFile_ke_dosen2'] == "jpg") { ?>
                                                                            <a target="_blank" href="<?= base_url() . 'uploadedFile/' . $d['file_chat_ke_dosen2'] ?>">
                                                                                <img src="uploadedFile/<?= $d['file_chat_ke_dosen2'] ?>" style="width: 70px; height:70px" alt=""> <br>
                                                                            </a> <br>
                                                                        <?php } else if ($d['extensiFile_ke_dosen2'] != "png" || $d['extensiFile_ke_dosen2'] != "jpg") { ?>
                                                                            <a target="_blank" href="<?= base_url() . 'uploadedFile/' . $d['file_chat_ke_dosen2'] ?>"><?= $d['file_chat_ke_dosen2']  ?></a> <br>
                                                                        <?php } ?>
                                                                    ...
                                                                    <div class="modal-dialog modal-dialog-centered " style="width: 300px;">
                                                                        <div class="modal-content">
                                                                            <div class="modal-footer text-center">
                                                                                ...
                                                                                <form action="/DosenController/deleteChat1/<?= $d['id'] ?>" method="post">
                                                                                    <input type="hidden" name="id" value="<?= $d['id'] ?>">
                                                                                    <input type="hidden" name="nama_mhs" value="<?= $d['nama_mhs'] ?>">
                                                                                    <input type="hidden" name="nama_dosen1" value="<?= $d['nama_dosen1'] ?>">
                                                                                    <input type="hidden" name="status_hapus_chat_dari_dosen1" value="Anda menghapus pesan ini">
                                                                ...
                                                                <div style="padding-top:150px">
                                                                    <div class="modal-dialog modal-dialog-centered " style="width: 300px;">
                                                                        <div class="modal-content">
                                                                            <div class="modal-footer text-center">
                                                                                <button type="button" class="btn btn-sm btn-warning" data-bs-target="#exampleModalToggle2" data-bs-toggle="modal" data-bs-dismiss="modal">Teruskan <i class="fa fa-share"></i></button>
                                                                                <form action="/DosenController/deleteChat2/<?= $d['id'] ?>" method="post">
                                                                                    <input type="hidden" name="id" value="<?= $d['id'] ?>">
                                                                                    <input type="hidden" name="nama_mhs" value="<?= $d['nama_mhs'] ?>">
                                                                                    <input type="hidden" name="nama_dosen2" value="<?= $d['nama_dosen2'] ?>">
                                                                                    <input type="hidden" name="status_hapus_chat_dari_dosen2" value="Anda menghapus pesan ini">
                                                                                    <button type="submit" class="btn btn-sm btn-danger">Hapus<i class="fa fa-trash"></i></button>
                                                                                </form>
                                                                                <button type="button" class="btn btn-sm btn-secondary" data-bs-dismiss="modal">Tutup X</button>
                                                                            </div>
                                                        ...
                                                        <center>
                                                            <div style="padding-top:150px">
                                                                <div class="modal-dialog modal-dialog-centered " style="width: 300px;">
                                                                    <div class="modal-content">
                                                                        <div class="modal-footer text-center">
                                                                            <form action="/DosenController/deletePermanenDosen1/<?= $d['id'] ?>" method="post">
                                ...
                                <div class="message-bar">
                                    <div class="message-inner">
                                        ...
                                        <div class="message-area">
                                            <?php if ($dosen_online == "dosen1") { ?>
                                                <form action="/tambahChatDariDosen1" method="post">
                                                    <?= csrf_field(); ?>
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" placeholder="Ketik pesan" name="chat_dari_dosen1" autofocus required>
                                                        <!-- <input type="hidden" name="nama_dosen" value=""> -->
                                                        <input type="hidden" name="nama_dosen1" value="<?= session()->get('nama_dosen'); ?>">
                                                        <input type="hidden" name="nama_mhs" value="<?= $nama_mahasiswa; ?>">
                                                        <span class="input-group-append">
                                            ...
                                            <?php } else { ?>
                                                <form action="/tambahChatDariDosen2" method="post">
                                                    <?= csrf_field(); ?>
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" placeholder="Ketik pesan" name="chat_dari_dosen2" autofocus required>
                                                        <!-- <input type="hidden" name="nama_dosen" value=""> -->
                                                        <input type="hidden" name="nama_dosen2" value="<?= session()->get('nama_dosen'); ?>">
                                                        <input type="hidden" name="nama_mhs" value="<?= $nama_mahasiswa; ?>">
                                                        <span class="input-group-append">
                                                            <button class="btn btn-info" type="submit"><i class="fas fa-paper-plane"></i></button>
                                                        </span>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body p-t-0">
                            <?php if ($dosen_online == "dosen1") { ?>
                                <form id="js-upload-form" action="/lampirkanFileDosen1/save" method="post" enctype="multipart/form-data">
                                    <input type="file" class="upload-drop-zone form-control" id="drop-zone" name="file_chat_dosen1_ke_mhs">
                            ...
                            <?php } else { ?>
                                <form id="js-upload-form" action="/lampirkanFileDosen2/save" method="post" enctype="multipart/form-data">
                                    <input type="file" class="upload-drop-zone form-control" id="drop-zone" name="file_chat_dosen2_ke_mhs">
                                    <i class="fas fa-cloud-upload fa-2x"></i>
                                    </input>
                                    <!-- <input type="hidden" name="nama_dosen" value=""> -->
                                    <input type="hidden" name="nama_dosen2" value="<?= session()->get('nama_dosen'); ?>">
                                        ...
                                        <a href="#">
                                            <div class="media">
                                                <span class="avatar align-self-center">
                                                    <img src="admin/assets/img/user.jpg" alt="<?= $nama_mahasiswa; ?>">
                                                </span>
