...
<body>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Daftar Mahasiswa Ujian Tutup</h4>
                                <div class="mb-2"></div>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($mahasiswa as $m) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="/ubahStatusAccKaprodiTutup/<?= $m['id'] ?>" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i> Ubah ACC Kaprodi</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
    ...
    <script>
        function htmlTableToExcel(type) {
            ...
            XLSX.writeFile(excelFile, 'Daftar Mahasiswa Ujian Skripsi - Teknik Informatika.' + type);
        }
    </script>
