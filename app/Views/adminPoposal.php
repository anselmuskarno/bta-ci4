...
<body>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Daftar Mahasiswa Untuk Seminar Proposal</h4>
                            </div>
                            <div class="card-body">

                                <a href="/cetakMhsACCProposal" target="_blank">
                                    <div class="btn btn-sm btn-warning mb-3">Cetak Data Mahasiswa Sudah ACC</div>
                                </a>
                                <a href="/cetakMhsBelumACCProposal" target="_blank">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php if ($m['acc_dosen1'] == "1" && $m['acc_dosen2'] == "1" && $m['acc_kaprodi'] == "1") { ?>
                                                            <form action="/pindahKeHasil/<?= $m['id'] ?>" method="post" class="d-inline">
                                                                <input type="hidden" name="nama_ujian" value="tutup">
                                                                <button type="submit" class="btn btn-sm bg-warning text-white">Pindahkan Ke Seminar Hasil</button>
                                                            </form>
                                                        <?php  } else { ?>
    ...
    <script>
        function htmlTableToExcel(type) {
            ...
            XLSX.writeFile(excelFile, 'Daftar Mahasiswa Proposal - Teknik Informatika.' + type);
        }
    </script>
</body>
