                                ...
                                <div class="navbar">
                                    <div class="user-details mr-auto">
                                        ...
                                        <div class="user-info float-left">
                                            <a href="#!" title="Mike Litorus"><span class="font-bold"><?= session()->get('nama_dosen_2'); ?></span> </a> <br>
                                            <span class="Last-seen">Dosen Pembimbing 2</span>
                                        </div>
                                    </div>
                                        ...
                                        <div class="chat-box">
                                            <div class="chats" id="printableArea">
                                                ...
                                                <?php foreach ($dosen as $d) : ?>
                                                    ...
                                                    <?php if ($d['file_chat_ke_dosen2'] != null &&  $d['status_hapus_chat_ke_dosen2'] == null) { ?>
                                                                ...
                                                                <div class="chat-bubble d-flex justify-content-end">
                                                                    ...
                                                                    <div class="chat-content">
                                                                        ...
                                                                        <?php } else if ($d['extensiFile_ke_dosen2'] != "png" || $d['extensiFile_ke_dosen2'] != "jpg") { ?>
                                                                            <a target="_blank" href="<?= base_url() . 'uploadedFile/' . $d['file_chat_ke_dosen2'] ?>"><?= $d['file_chat_ke_dosen2']  ?></a> <br><br>
                                                                        <?php } ?>
                                                    ...
                                                    <?php } else if ($d['chat_ke_dosen_2'] != null &&  $d['status_hapus_chat_ke_dosen2'] == null) { ?>
                                                        <div class="chat chat-right" data-bs-toggle="modal" data-bs-target="#exampleModal<?= $d['id'] ?>">
                                                            <div class="chat-body ansel">
                                                                <div class="chat-bubble">
                                                                    <div class="chat-content">
                                                                        <p class="paragraph"><?= $d['chat_ke_dosen_2']  ?></p>
                                                                        <span class="chat-time spanku">8:30 am</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <?php } else if ($d['chat_dari_dosen2'] != null) { ?>
                                                        <div class="chat chat-left" data-bs-toggle="modal" data-bs-target="#exampleModal<?= $d['id'] ?>">
                                                            ...
                                                            <div class="chat-body">
                                                                <div class="chat-bubble">
                                                                    <div class="chat-content">
                                                                        <p><?= $d['chat_dari_dosen2']  ?></p>
                                                                        <span class="chat-time">8:30 am</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    <?php } else if ($d['file_chat_dosen2_ke_mhs'] != null) { ?>
                                                                ...
                                                                <div class="chat-bubble">
                                                                    <div class="chat-content">
                                                                        ...
                                                                        <?php } else if ($d['extensiFileDosen2_ke_mhs'] != "png" || $d['extensiFileDosen2_ke_mhs'] != "jpg") { ?>
                                                                            <a target="_blank" href="<?= base_url() . 'uploadedFile/' . $d['file_chat_dosen2_ke_mhs'] ?>"><?= $d['file_chat_dosen2_ke_mhs']  ?></a><br> <br>
                                                                        <?php } ?>
                                                                        <span class="chat-time spanku">8:30 am</span>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="modal-dialog modal-dialog-centered " style="width: 300px;">
                                                                    <div class="modal-content">
                                                                        <div class="modal-footer text-center">
                                                                            ...
                                                                            <form action="/DosenController/delete2/<?= $d['id'] ?>" method="post">
                                                                                <input type="hidden" name="id" value="<?= $d['id'] ?>">
                                                                                <input type="hidden" name="nama_mhs" value="<?= $d['nama_mhs'] ?>">
                                                                                <input type="hidden" name="nama_dosen2" value="<?= $d['nama_dosen2'] ?>">
                                                                                <input type="hidden" name="file_chat_ke_dosen2" value="<?= $d['file_chat_ke_dosen2'] ?>">
                                                                                <input type="hidden" name="chat_dari_dosen2" value="<?= $d['chat_dari_dosen2'] ?>">
                                                                                <input type="hidden" name="chat_ke_dosen_2" value="<?= $d['chat_ke_dosen_2'] ?>">
                                                                                <input type="hidden" name="tanggal_chat_ke_dosen2" value="<?= $d['tanggal_chat_ke_dosen2'] ?>">
                                                                                <input type="hidden" name="status_hapus_chat_ke_dosen2" value="Anda menghapus pesan ini">
                                                                                <input type="hidden" name="status_baca_dosen2" value="<?= $d['status_baca_dosen2'] ?>">
                                                        ...
                                                        <center>
                                                            <div style="padding-top:150px">
                                                                <div class="modal-dialog modal-dialog-centered " style="width: 300px;">
                                                                    <div class="modal-content">
                                                                        <div class="modal-footer text-center">
                                                                            <form action="/DosenController/deletePermanen2/<?= $d['id'] ?>" method="post">
                                ...
                                <div class="message-bar">
                                    <div class="message-inner">
                                        ...
                                        <div class="message-area">
                                            <form action="/tambahChatDariMhs2" method="post">
                                                <?= csrf_field(); ?>
                                                <div class="input-group">
                                                    <input type="text" class="form-control" placeholder="Ketik pesan" name="chat_ke_dosen_2" autofocus required>
                                                    <!-- <input type="hidden" name="nama_dosen" value=""> -->
                                                    <input type="hidden" name="nama_dosen2" value="<?= session()->get('nama_dosen_2'); ?>">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body p-t-0">
                            <form id="js-upload-form" action="/lampirkanFile2/save" method="post" enctype="multipart/form-data">
                                <input type="file" class="upload-drop-zone form-control" id="drop-zone" name="file_chat_ke_dosen2">
                                        ...
                                        <a href="#">
                                            <div class="media">
                                                ...
                                                <div class="media-body text-nowrap align-self-center">
                                                    <div class="user-name"><?= session()->get('nama_dosen_2'); ?></div>
                                                    <span class="designation"><?= session()->get('jabatan_2'); ?></span>
                                                </div>
                                                <div class="align-self-center text-nowrap">
