                                    ...
                                    <div class="modal-dialog modal-dialog-centered ">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalToggleLabel2">Tambah Data Dosen </h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                                                <div class="container">
                                                    <form action="/tambahDosen" method="post">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="password" class="form-control" name="password_dosen" required>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($dosen as $d) : ?>
                                                <tr>
                                                    ...
                                                    <td><?= $d['nama_dosen']  ?></td>
                                                    <td>
                                                        <span class="btn btn-sm bg-info text-white" data-bs-target="#detailModal<?= $d['id'] ?>" data-bs-toggle="modal" data-bs-dismiss="modal">Detail</span>
                                                        <a href="/deleteDosen/<?= $d['id'] ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')"> <span class="btn btn-sm bg-danger text-white">Hapus</span></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
                                    ...
                                    <div class="container">
                                        <form>
                                            <div class="form-group row">
                                                <label class="col-md-3 col-form-label">Username</label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" value="<?= $d['username'] ?>" disabled>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-md-3 col-form-label">Password</label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" value="<?= $d['password_dosen'] ?>" disabled>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-md-3 col-form-label">Nama Dosen</label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" value="<?= $d['nama_dosen'] ?>" disabled>
                                                </div>
                                            </div>
                                            <div class="text-right">
                                                <button type="button" class="btn btn-sm btn-secondary" data-bs-dismiss="modal">Tutup X</button>
