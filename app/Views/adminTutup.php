...
<body>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Daftar Mahasiswa Untuk Ujian Tutup</h4>
                            </div>
                            <div class="card-body">
                                <a href="/cetakMhsACCTutup" target="_blank">
                                    <div class="btn btn-sm btn-warning mb-3">Cetak Data Mahasiswa Sudah ACC</div>
                                </a>
                                <a href="/cetakMhsBelumACCTutup" target="_blank">
                                            ...
                                            foreach ($mahasiswa as $m) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')" href="/deleteMahasiswaTutup/<?= $m['id'] ?>"> <span class="btn btn-sm bg-danger text-white">Hapus</span></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
    ...
    <script>
        function htmlTableToExcel(type) {
            ...
            XLSX.writeFile(excelFile, 'Daftar Ujian Skripsi - Teknik Informatika.' + type);
        }
    </script>
</body>
